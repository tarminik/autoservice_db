...
| phone_no      | номер телефона клиента            | varchar(50)     |                 |
| tg_username   | имя клиента в телеграмме          | varchar(50)     | NOT NULL        |
...
| customer_id   | id клиента                        | integer         | FOREIGN KEY     |
| maker         | марка автомобиля                  | varchar(50)     |                 |
| model         | модель автомобиля                 | varchar(50)     |                 |
| year          | год выпуска                       | integer         |                 |
| reg_no        | регистрационный номер             | varchar(50)     |                 |
...
| maker         | производитель детали              | varchar(50)     |                 |
| detail_cnt    | количество деталей                | integer         |                 |
| price         | цена                              | real            |                 |
| detail_nm     | название детали                   | varchar(50)     |                 |
